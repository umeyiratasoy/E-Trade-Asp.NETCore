...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult> RefreshTokenLogin([FromBody] RefreshTokenLoginCommandRQ refreshTokenLoginCommandRQ)
        {
            RefreshTokenLoginCommandRP response = await _mediator.Send(refreshTokenLoginCommandRQ);
            return Ok(response);
        }
